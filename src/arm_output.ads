...
package ARM_Output is
   ...
   procedure Section
     (Output_Object : in out Output_Type; Section_Title : in String;
   ...
   subtype Tab_Location is
     Natural range 0 .. 200; -- Location of tab stops, in picas.
   ...
   NO_TABS : constant Tab_Info :=
     (Number => 0, Stops => (others => (Kind => Left_Fixed, Stop => 0)));
   ...
   procedure Category_Header
     (Output_Object : in out Output_Type; Header_Text : String) is abstract;
   ...
   procedure Clause_Header
     (Output_Object              : in out Output_Type; Header_Text : in String;
   ...
   procedure Revised_Clause_Header
     (Output_Object : in out Output_Type; New_Header_Text : in String;
   ...
   procedure TOC_Marker
     (Output_Object : in out Output_Type; For_Start : in Boolean) is abstract;
   ...
   procedure Start_Table
     (Output_Object : in out Output_Type; Columns : in ARM_Output.Column_Count;
   ...
   type Table_Marker_Type is
     (End_Caption, End_Item, End_Header, End_Row, End_Row_Next_Is_Last,
      End_Table);
   ...
   procedure Ordinary_Text
     (Output_Object : in out Output_Type; Text : in String) is abstract;
   -- Output ordinary text.
   -- The text must end at a word break, never in the middle of a word.

   procedure Ordinary_Character
     (Output_Object : in out Output_Type; Char : in Character) is abstract;
   ...
   procedure Soft_Hyphen_Break
     (Output_Object : in out Output_Type) is abstract;
...
-- a hyphen will be added to the text.
   ...
   type Special_Character_Type is
   ...
   NORMAL_FORMAT : constant Format_Type :=
     (Bold     => False, Italic => False, Font => Default, Size => 0,
      Color => Default, Change => None, Version => '0', Added_Version => '0',
      Location => Normal);
   ...
   procedure Clause_Reference
     (Output_Object : in out Output_Type; Text : in String;
   ...
   procedure Index_Target
     (Output_Object : in out Output_Type; Index_Key : in Natural) is abstract;
   ...
   procedure Index_Reference
     (Output_Object : in out Output_Type; Text : in String;
      Index_Key     : in     Natural; Clause_Number : in String) is abstract;
   ...
   procedure Local_Link
     (Output_Object : in out Output_Type; Text : in String; Target : in String;
      Clause_Number : in     String) is abstract;
   ...
   procedure Local_Link_Start
     (Output_Object : in out Output_Type; Target : in String;
      Clause_Number : in     String) is abstract;
   -- Generate a local link to the target and clause given.
   ...
   type Picture_Alignment is
     (Inline, Float_Left, Float_Right, Alone_Left, Alone_Right, Alone_Center);
   ...
   procedure Picture
     (Output_Object : in out Output_Type; Name : in String; Descr : in String;
      Alignment : in ARM_Output.Picture_Alignment; Height, Width : in Natural;
