package ARM_Database is
   ...
   type Paragraph_Change_Kind_Type is
     (None, Inserted, Inserted_Normal_Number, Deleted, Deleted_Inserted_Number,
      Deleted_No_Delete_Message, Deleted_Inserted_Number_No_Delete_Message,
   ...
   generic
      with procedure Format_Text (Text : in String; Text_Name : in String);
   procedure Report
