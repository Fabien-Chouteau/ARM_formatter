...
private
   ...
   type RTF_Output_Type is new ARM_Output.Output_Type with record
      ...
      Column_Count : ARM_Output.Column_Count :=
        1; -- Number of columns in current section.
      ...
      Table_Column_Width : Natural :=
        0; -- The column width of the table, in twips.
      Table_First_Column_Mult : ARM_Output.Column_Count :=
        1; -- The multiple of the first column.
      Table_Last_Column_Mult : ARM_Output.Column_Count :=
        1; -- The multiple of the last column.
      Table_Alignment : ARM_Output.Column_Text_Alignment :=
        ARM_Output.Center_All;
      Table_No_Page_Break : Boolean :=
        False; -- Is a page break allowed in the table?
      Table_Has_Border     : Boolean := False; -- Does the table have a border?
      Table_Has_Small_Text : Boolean :=
        False; -- Does the table have small text?
      -- Pictures:
      Last_Shape_Id : Natural := 1_024; -- Shape ids.
   end record;
