...
package body ARM_File is
   ...
   procedure Open
     (Input_Object : in out File_Input_Type; File_Name : in String)
   is
   ...
   begin
      ...
      if File_Name'Length > Input_Object.Name'Length then
         Input_Object.Name :=
           File_Name
             (File_Name'First ..
                  File_Name'First + Input_Object.Name'Length - 1);
   ...
   procedure Get_Char
     (Input_Object : in out File_Input_Type; Char : out Character)
   is
   ...
   begin
      ...
      if Input_Object.Extra_LF then
         ...
         begin
            Ada.Text_IO.Get_Line
              (Input_Object.Fyle, Input_Object.Buffer,
         ...
         if Input_Object.Buffer_Last < Input_Object.Buffer'Last then
            ...
            Input_Object.Buffer (Input_Object.Buffer_Last) :=
              ASCII.LF; -- Line end marker.
      ...
      if Input_Object.Recording then
         ...
         if Input_Object.Recording_Len > Input_Object.Recording_Buffer'Last
         then
            Ada.Text_IO.Put_Line
              ("  ** Too many characters recorded on line " &
               Line_String (Input_Object));
            Ada.Text_IO.Put_Line
              ("     Recording started on line" &
               Natural'Image (Input_Object.Recording_Start_Line));
   ...
   begin
      ...
      return
        Natural'Image (Input_Object.Line_Counter) & " - " &
   ...
   begin
      ...
      if Input_Object.Recording_Len > Result'Length then
         ...
         Result
           (Result'First .. Result'First + Input_Object.Recording_Len - 1) :=
