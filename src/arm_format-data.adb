...
package body ARM_Format.Data is
   ...
   function Command (Name : in ARM_Input.Command_Name_Type) return Command_Type
   is
   ...
   begin
      if Canonical_Name = "begin" then
         ...
         return Trailing;
      elsif Canonical_Name = "+"
      then -- Can't happen directly, but can happen through stacking.
         return Up;
      elsif Canonical_Name = "-"
      then -- Can't happen directly, but can happen through stacking.
         return Down;
